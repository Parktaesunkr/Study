...
public class CoordinateExample2 {
	...
	public static void main(String[] args) {
		...
		System.out.print("X좌표 : "); x = sc.nextDouble();
		System.out.print("Y좌표 : "); y = sc.nextDouble();
		...
		System.out.println(compCoordinate(p, q) ? "p와 q가 같습니다." : 
			"p와 q가 다릅니다.");
